        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="row">  
                    <c:forEach items="${selectTop100}" var="top100">                    
                     <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">              
                          <a id="bookClick" href="BookDetail.do?bookno=${top100.bookNo}">
                           <div class="product__item__pic set-bg" onclick="location.href='BookDetail.do?bookno=${top100.bookNo}'" data-setbg="${top100.bookImg}">                     
                                </a>
